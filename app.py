...
D = st.number_input("Діаметр резервуара (м)", min_value=0.1, value=5.0, step=0.1)
L = st.number_input("Довжина резервуара (м)", min_value=0.1, value=10.0, step=0.1)
Wrem = st.number_input("Ширина ремонтної ділянки (м)", min_value=0.1, value=3.0, step=0.1)
...
if st.button("Розрахувати"):
    ...
    заг_площа = 2 * cum_area_bot + площа_cyl
